...
def test_lifecycle_renderer_filters_and_opens_project_sources():
    ...
    program = (
        ...
        "vote:1},latest_event:{event_type:'vote',event_label:'Vot <x>',"
        "occurred_at:'2026-09-12'}},source_attention:{needs_attention:true,"
        "source_state:'ok',registry_source_state:'changed',registry_can_sync:true,"
        "registry_source_id:'src_1',uncertainty:{level:'medium',reasons:['stale <x>']}},"
        ...
        "assert.ok(cockpit.includes('vote: 1'));"
