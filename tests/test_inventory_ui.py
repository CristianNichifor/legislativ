...
def test_source_registry_renderer_shows_econsultare_snapshot_and_registration_copy():
    ...
    program = (
        ...
        "let h=sourceRegistryRowHtml(row,{consultare_econsultare:'Consultări publice · e-consultare'});"
        ...
        "assert.ok(!h.includes('<script>')&&!h.includes('<img>'));"
        "h=sourceRegistryDetailHtml(row,{consultare_econsultare:'Consultări publice · e-consultare'});"
