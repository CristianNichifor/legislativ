        ...
        def _get(self, stare) -> None:
            ...
            if ruta.path == "/":
                ...
                try:
                    ...
                    self._json({"error": str(exc)}, 400)
            elif ruta.path == "/api/project-cockpit":
                from scripts.project_cockpit import build
                ...
                try:
                    ...
                    elif ruta.path == "/api/dosare/rule-drafts":
                        from scripts import law_rule_drafts

                        out = law_rule_drafts.lista(
                            path,
                            ident,
                            int(qs.get("offset", ["0"])[0]),
                            act_id=qs.get("act", [""])[0],
            ...
            if ruta in (
                ...
                try:
                    ...
                    if ruta == "/api/dosare/metadate":
                        ...
                        out = executa(path, cerere)
                    elif ruta == "/api/dosare/rule-drafts":
                        ...
                        out = preview(cerere)
                    elif ruta == "/api/dosare/ai-draft/mcp-execute":
