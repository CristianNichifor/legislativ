...
from scripts import dosare, mcp_ai_draft
...
def test_config(request: dict) -> dict:
    ...
    supported = server == SUPPORTED_SERVER and tool == SUPPORTED_TOOL
    return {
        ...
        "app_paid_ai": False,
        "supported_workflows": ["ai_draft"] if supported else [],
        "limitari": [
            "V1 rulează doar adaptorul local-mock/ai.draft în teste.",
